# Change these things
CODE_DIRS_TO_MOUNT = [
    '/home/patrickhaoy/code_goalbisim',
    '/home/patrickhaoy/code_goalbisim/railrl-private',
    '/home/patrickhaoy/code_goalbisim/bullet-manipulation',
    '/home/patrickhaoy/code_goalbisim/environments',
    '/home/patrickhaoy/code_goalbisim/goalbisim',
...
LOCAL_LOG_DIR = '/2tb/home/patrickhaoy/data_goalbisim/logs' #'/2tb/home/patrickhaoy/data/affordances' #'/media/ashvin/data2/s3doodad' # '/home/ashvin/data/s3doodad'
...
DOODAD_DOCKER_IMAGE = "patrickhaoy/railrl-goalbisim-v1" #"anair17/railrl-dice-v1" # 'anair17/railrl-hand-v3' # 'anair17/railrl-gpu-v7a' # 'anair17/railrl-gpu-v6-cuda9' # 'anair17/railrl-gpu-v6' # 'vitchyr/railrl-vitchyr-gpu-v2-2'
...
GPU_DOODAD_DOCKER_IMAGE = "patrickhaoy/railrl-goalbisim-v1" #"anair17/railrl-dice-v1" # "anair17/borel-v2" #
...
SSS_CODE_DIRS_TO_MOUNT = [
    ...
    '/home/patrickhaoy/code_goalbisim/goalbisim',
    '/home/patrickhaoy/code_goalbisim/bullet-objects',
    '/home/patrickhaoy/code_goalbisim/doodad',
]
...
GCP_BUCKET='patrick-ssl-gcp-bucket'
GCP_PROJECT='fit-oasis-315121'
GCP_IMAGE='ashvin-torch4cuda9-ssl'
...
GCP_IMAGE_NAME = 'ashvin-torch4cuda9-ssl'
GCP_GPU_IMAGE_NAME = 'ashvin-torch4cuda9-ssl'
GCP_BUCKET_NAME = 'patrick-ssl-gcp-bucket'
